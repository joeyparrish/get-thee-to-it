...
# Utilities for handling /bot commands.
# Forked from https://github.com/shaka-project/shaka-player/blob/main/.github/workflows/shaka-bot-commands/lib.sh
...
function reply() {
  echo "@$COMMENTER: $@" | \
      gh issue comment "$ISSUE_NUMBER" -R "$THIS_REPO" -F -
}
